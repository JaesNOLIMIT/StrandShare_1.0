-- 131_force_replace_bundle_scan_rpc_without_submission_code.sql
-- Force-replace bundling RPCs to remove any dependency on Hair_Submissions.Submission_Code.
-- This fixes legacy deployments where an older function body still references
-- `hs.Submission_Code` during bundling scans.
