-- 134_allow_staff_rejected_to_appealed_event_requests.sql
-- Fix staff appeal transition:
-- - Allow Event_Requests status transition Rejected -> Appealed
-- - Keep backward-compatible support for Rejected -> Pending Admin Approval
-- - Ensure status constraint accepts "Appealed"
